...
print("protected class = sex: %s" % mean_difference(credit_risk, sex))
# 0.0748013090229
print("protected class = foreign: %s" % mean_difference(credit_risk, foreign))
# 0.199264685246

print("\nNormalized mean difference scores:")
# normalized mean difference
print("protected class = sex: %s" %
      normalized_mean_difference(credit_risk, sex))
# 0.0772946859903
print("protected class = foreign: %s" %
      normalized_mean_difference(credit_risk, foreign))
# 0.63963963964
