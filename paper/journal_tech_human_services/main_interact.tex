...
% \author{
%   \name{Niels Bantilan\textsuperscript{a}\thanks{Contact: Niels Bantilan. Email: niels.bantilan@gmail.com}}
%   \affil{\textsuperscript{a}Arena.io, New York, NY}
% }

% For the draft version
\author{
  \name{Anonymous\textsuperscript{a}\thanks{Contact: anonymous. Email: anonymous}}
  \affil{\textsuperscript{a}no affiliation}
}
...
% \href{https://github.com/cosmicBboy/themis-ml}{\underline{github}}.)
